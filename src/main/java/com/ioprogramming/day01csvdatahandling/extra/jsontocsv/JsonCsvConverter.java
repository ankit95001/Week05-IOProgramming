...
class JsonCsvConverter {
    ...
    public static void main(String[] args) {
        String jsonFile = "src/main/java/com/ioprogramming/day01csvdatahandling/extra/jsontocsv/students.json";
        String csvFile = "src/main/java/com/ioprogramming/day01csvdatahandling/extra/jsontocsv/students.csv";
        String newJsonFile = "src/main/java/com/ioprogramming/day01csvdatahandling/extra/jsontocsv/converted_students.json";
